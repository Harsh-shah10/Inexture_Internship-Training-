...
user_data_base = {	
    1:{
        "cc":10,"Bank":1,"name":"Harsh","balance":10000,"Transacn_Count":0,"dailyTransnLimit":0,"ccpin":0000
    },
    2:{
        "cc":11,"Bank":2,"name":"Piyush","balance":10000,"Transacn_Count":0,"dailyTransnLimit":0,"ccpin":1234
    }
}
...
def deposit():
    if user_data_base[user_id]['Transacn_Count'] >= 4 or user_data_base[user_id]["dailyTransnLimit"]>=50000:
        print("\nDaily transcation limit reached")
        return
    list_atm()

    SelectedATM = int(input("\nSelect ATM : "))
...
def add_user():
    ...
    user_data_base[user_id]['dailyTransnLimit'] = 0
