...
# for choosing who will go first in comp vs human
def choose_chance(n):
    global firstComputerMove
    if n==2:
        print("\n--------------------------------------------")
        print("Choose Who would like to get first turn : ")
...
# for choosing who will go first in human1[x] vs human2[0]
def choose_chance_humanvshuman(n):
    global xplayermove
    if n==1:
        print("\n--------------------------------------------")
        print("Who would like to get first turn : ")
        print("1. Player 1 'X' \n2. Player 2 '0'")
        while True:
            Choose  = input("Enter Your Choice : ")
            if Choose.isnumeric() == True:
...
def menu():
    ...
    # First choice will only be asked once for the 2 option comp v/s human
    c = 0
